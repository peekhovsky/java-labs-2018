...
public class Persons extends ArrayList<Person> implements Serializable {
	...
	/**location with xld file with a list of persons*/
	private String xldLocation;
	/**last id */
	public Integer lastId;

	/**Constructor
	 * @param location location with xml-file with a list of persons*/
	public Persons(String location, String xldLocation) {
		this.location = location;
		this.xldLocation = xldLocation;
	}

	/**reads data from xml-file*/
	public boolean read() {
		return PersonsIO.read(location, xldLocation, this);
	}
